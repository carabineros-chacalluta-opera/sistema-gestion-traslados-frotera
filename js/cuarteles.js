// ═══════════════════════════════════════════════════════════════
// SIGDOF · Módulo Cuarteles (CRUD) v2.0
// ═══════════════════════════════════════════════════════════════
...
const Cuarteles = {
  ...
  renderResumen() {
    const totalOptimo   = this.data.reduce((s,c) => s + Utils.dotacionOptima(c), 0);
  ...
  renderTabla() {
    ...
    cont.innerHTML = filtrados.map(c => {
      ...
      const criticidadColor = Utils.colorCriticidad(c.criticidad);
